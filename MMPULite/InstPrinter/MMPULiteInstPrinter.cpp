//===- MMPULiteInstPrinter.cpp - Convert MMPULite MCInst to assembly syntax -===//
//
...
void
MMPULiteInstPrinter::printInst(const MCInst *MI, raw_ostream &O,
							StringRef Annot)
{
	O<<"\t"; // at start of line
...
void
MMPULiteInstPrinter::printOperand(const MCInst *MI, unsigned OpNo,
								raw_ostream &O) const
{
...
void MMPULiteInstPrinter::printFlags(const MCInst *MI, unsigned OpNo, raw_ostream &O) const
{
	const MCOperand& MO = MI->getOperand(OpNo);
...
void MMPULiteInstPrinter::printKIReg(const MCInst *MI, unsigned OpNo, raw_ostream &O) const
{
	const MCOperand& MO = MI->getOperand(OpNo);
...
void MMPULiteInstPrinter::printIPath(const MCInst *MI, unsigned OpNo, raw_ostream &O) const
{
	const MCOperand& MO = MI->getOperand(OpNo);
...
void MMPULiteInstPrinter::printMACCTI(const MCInst *MI,
                                      unsigned int OpNo,
                                      raw_ostream &O) const {
