...
static UCPS::UCPSAsmOperand *opc, *tm, *tn, *tp, *f, *unit, *ut, *b, *md, *ms, *imm, *expr, *ipath;
static int slotid;
...
%%
mcodeline: NOOP LINEEND {ADDOPERAND(Opc, UCPS::NOP, @1.S, @1.E); YYACCEPT;}
...
mr012slot: R0 DOT r0inst {
  switch ($3) {
  case 0:
    ADDOPERAND(Opc, UCPS::MR0ToM, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(std::unique_ptr<UCPS::UCPSAsmOperand>(md)));
    Operands.push_back(nullptr);
    condpos = Operands.size();
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ms));
    ADDOPERAND(Reg,
               MRI->getRegClass(UCPSReg::WFlagRegClassID).getRegister(0),
               @$.S, @$.E);
    break;
  case 1:
    ADDOPERAND(Opc, UCPS::MR0ToSHU, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
    Operands.push_back(nullptr);
    condpos = Operands.size();
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    ADDOPERAND(Reg,
               MRI->getRegClass(UCPSReg::WFlagRegClassID).getRegister(0),
               @$.S, @$.E);
    break;
  case 3:
    ADDOPERAND(Opc, UCPS::MR0ToMACC, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ipath));
    Operands.push_back(nullptr);
    condpos = Operands.size();
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    ADDOPERAND(Reg,
...
| R1 DOT r1inst {
  if ($3 == 1)
    ADDOPERAND(Opc, UCPS::MR1ToSHU, @$.S, @$.E);
  else if ($3 == 3)
    ADDOPERAND(Opc, UCPS::MR1ToMACC, @$.S, @$.E);
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  if ($3 == 3) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ipath));
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
  ADDOPERAND(Reg,
...
| R2 DOT r2inst {
  ADDOPERAND(Opc, UCPS::MR2ToMACC, @$.S, @$.E);
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ipath));
  Operands.push_back(nullptr);
...
| R2 DOT r2instw {
  ...
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
  ADDOPERAND(Reg,
             MRI->getRegClass(UCPSReg::WFlagRegClassID).getRegister($3),
             @$.S, @$.E);
  slotid = 2;
};
mr3slot: mr3slot_ {
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b));
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
  if (!$1)
...
imacslot: imacinst | imacctrl | mrinst {
  ...
  flags.reset();
  switch($1) {
  case 1: ADDOPERAND(Opc, UCPS::IMAcc, @$.S, @$.E); break;
  case 2: ADDOPERAND(Opc, UCPS::IMaC, @$.S, @$.E); break;
  case 3: ADDOPERAND(Opc, UCPS::IMA, @$.S, @$.E); break;
  default: break;
  }
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
  if ($1 >= 2) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tn));
  if ($1 == 3) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tp));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(f));
};
...
fmacslot: fmacinst | fmacctrl | fmrinst {
  ...
  flags.reset();
  switch($1) {
  case 2: ADDOPERAND(Opc, UCPS::FMaC, @$.S, @$.E); break;
  case 3: ADDOPERAND(Opc, UCPS::FMA, @$.S, @$.E); break;
  default: break;
  }
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tn));
  if ($1 == 3) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tp));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(f));
};
...
r3inst: mindexn ASSIGNTO r3dest _flag KG flag_ {
  $$ = 1;
  ADDOPERAND(Opc, UCPS::MR3ToBIUKG, @$.S, @$.E);
}
|       mindexn ASSIGNTO r3dest {
  $$ = 0;
  ADDOPERAND(Opc, UCPS::MR3ToBIU, @$.S, @$.E);
} ;
...
shu0inst: shuexp ASSIGNTO shu0dest {
  ...
  case 0:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU0IndTNoOptToM, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU0IndTOptToM, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU0IndTBNoOptToM, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU0IndTBOptToM, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU0CombToM, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    break;
  case 1:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU0IndTNoOptToSHU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU0IndTOptToSHU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU0IndTBNoOptToSHU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU0IndTBOptToSHU, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU0CombToSHU, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  case 2:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU0IndTNoOptToBIU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU0IndTOptToBIU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU0IndTBNoOptToBIU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU0IndTBOptToBIU, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU0CombToBIU, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b));
    break;
  case 3:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU0IndTNoOptToMACC, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU0IndTOptToMACC, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU0IndTBNoOptToMACC, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU0IndTBOptToMACC, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU0CombToMACC, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  Operands.push_back(nullptr);
  condpos = Operands.size();
  if ($1 == 6) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(opc));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
  switch ($1) {
  case 2:
  case 3:
  case 6:
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tn));
    if ($1 == 6) {
      tp = OPERAND(Reg, UCPSReg::T0, @$.S, @$.E);
      Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tp));
      Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(f));
      break;
    }
  case 4:
  case 5:
    ...
    else Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(imm));
    break;
  default : break;
  }
...
shu1inst: shuexp ASSIGNTO shu1dest {
  ...
  case 0:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU1IndTNoOptToM, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU1IndTOptToM, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU1IndTBNoOptToM, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU1IndTBOptToM, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU1CombToM, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    break;
  case 1:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU1IndTNoOptToSHU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU1IndTOptToSHU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU1IndTBNoOptToSHU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU1IndTBOptToSHU, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU1CombToSHU, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  case 2:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU1IndTNoOptToBIU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU1IndTOptToBIU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU1IndTBNoOptToBIU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU1IndTBOptToBIU, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU1CombToBIU, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b));
    break;
  case 3:
    switch ($1) {
    case 2: ADDOPERAND(Opc, UCPS::SHU1IndTNoOptToMACC, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::SHU1IndTOptToMACC, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::SHU1IndTBNoOptToMACC, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::SHU1IndTBOptToMACC, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::SHU1CombToMACC, @$.S, @$.E); break;
    default : break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
...
byclause: BY _flag shudupara flag_ {$$ = 6; opc = OPERAND(Reg, UCPSReg::COMB, @1.S, @1.E);};
shudupara: shusrct COMMA shusrct;
byexp: byclause _flag byflag flag_ | byclause;
shu0ctrl: SHU0 DOT ctrl {
  if ($3) ADDOPERAND(Opc, UCPS::SHU0Stop, @$.S, @$.E);
  else ADDOPERAND(Opc, UCPS::SHU0Start, @$.S, @$.E);
};
shu1ctrl: SHU1 DOT ctrl {
  if ($3) ADDOPERAND(Opc, UCPS::SHU1Stop, @$.S, @$.E);
  else ADDOPERAND(Opc, UCPS::SHU1Start, @$.S, @$.E);
};

ldinst: ldop lddest {
  unsigned distance = UCPS::BIU1LdToM - UCPS::BIU0LdToM;
  if ($2 == 0) {
    ADDOPERAND(Opc, UCPS::BIU0LdToM + distance * slotid, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
  } else {
    if ($2 == 1)
      ADDOPERAND(Opc, UCPS::BIU0LdToSHU + distance * slotid, @$.S, @$.E);
    else if ($2 == 3)
      ADDOPERAND(Opc, UCPS::BIU0LdToMACC + distance * slotid, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
    if ($2 == 3) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ipath));
  }
  Operands.push_back(nullptr);
  condpos = Operands.size();
};
...
stinst: storeop {
  unsigned distance = UCPS::BIU1St - UCPS::BIU0St;
  ADDOPERAND(Opc, UCPS::BIU0St + distance * slotid, @$.S, @$.E);
  Operands.push_back(nullptr);
  condpos = Operands.size();
};
storeop: ASSIGNTO DM | ASSIGNTO DM _flag stflag flag_;
kginst: _flag KG flag_ ASSIGNTO mindex {
  unsigned distance = UCPS::BIU1KG - UCPS::BIU0KG;
  ADDOPERAND(Opc, UCPS::BIU0KG + distance * slotid, @$.S, @$.E);
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
  Operands.push_back(nullptr);
  condpos = Operands.size();
};
...
ialuinst: ialuclause ASSIGNTO ialudest {
  ...
  case 0:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IALUDivRToM, @$.S, @$.E); break;
    case 1: ADDOPERAND(Opc, UCPS::IALUUryToM, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IALUBinToM, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IALUTPToM, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IALUDPToM, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IALUImmToM, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    break;
  case 1:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IALUDivRToSHU, @$.S, @$.E); break;
    case 1: ADDOPERAND(Opc, UCPS::IALUUryToSHU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IALUBinToSHU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IALUTPToSHU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IALUDPToSHU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IALUImmToSHU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  case 2:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IALUDivRToBIU, @$.S, @$.E); break;
    case 1: ADDOPERAND(Opc, UCPS::IALUUryToBIU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IALUBinToBIU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IALUTPToBIU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IALUDPToBIU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IALUImmToBIU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b));
    break;
  case 3:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IALUDivRToMACC, @$.S, @$.E); break;
    case 1: ADDOPERAND(Opc, UCPS::IALUUryToMACC, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IALUBinToMACC, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IALUTPToMACC, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IALUDPToMACC, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IALUImmToMACC, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  condpos = Operands.size();
  if ($1 > 0) {
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(opc));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
    if ($1 == 5) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(imm));
    else if ($1 != 0) {
      if ($1 == 1) tn = OPERAND(Reg, UCPSReg::T0, @$.S, @$.E);
      Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tn));
      if ($1 != 5 && $1 != 3) tp = OPERAND(Reg, UCPSReg::T0, @$.S, @$.E);
      if ($1 != 5) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tp));
    }
  }
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(f));
}
|         condclause ASSIGNTO ialudest{
  ...
  switch($3) {
  case 0:
    ADDOPERAND(Opc, UCPS::IALUBinToM, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    break;
  case 1:
    ADDOPERAND(Opc, UCPS::IALUBinToSHU, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
    break;
  case 2:
    ADDOPERAND(Opc, UCPS::IALUBinToBIU, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b));
    break;
  case 3:
    ADDOPERAND(Opc, UCPS::IALUBinToMACC, @$.S, @$.E);
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
    ADDOPERAND(Imm, 0, SMLoc(), SMLoc());
    break;
...
|         condclause ASSIGNTO COND{
  ...
  f = OPERAND(Imm, (flags.to_ulong() << 8) | flagsort, FlagS, FlagE);
  flags.reset();
  ADDOPERAND(Opc, UCPS::IALUToCond, @$.S, @$.E);
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(opc));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
...
utbclause: iaddclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::IADD, @$.S, @$.E);}|
           isubclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::ISUB, @$.S, @$.E);};
...
addexp: t ADD t ;
subexp: t SUB t ;
ubclause: imaxclause {$$ = 4; opc = OPERAND(Reg, UCPSReg::IMAX, @$.S, @$.E);}|
          iminclause {$$ = 4; opc = OPERAND(Reg, UCPSReg::IMIN, @$.S, @$.E);}|
          iabsclause {$$ = 4; opc = OPERAND(Reg, UCPSReg::IABS, @$.S, @$.E);}|
          iexpdclause {$$ = 1; opc = OPERAND(Reg, UCPSReg::EXPD, @$.S, @$.E);}|
          rshtclause {$$ = $1;};
condclause: iltclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::ILT, @$.S, @$.E);}|
            instclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::INST, @$.S, @$.E);}|
            istclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::IST, @$.S, @$.E);}|
            inltclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::INLT, @$.S, @$.E);};
...
nltexp: t NLT t ;
bclause: mrgclause {$$ = 3; opc = OPERAND(Reg, UCPSReg::MERGE, @$.S, @$.E);}|
         lshtclause;
condclause: iequclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::IEQU, @$.S, @$.E);}|
            ineqclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::INEQ, @$.S, @$.E);};
...
rshtexp: t rshtt {$$ = 2; opc = OPERAND(Reg, UCPSReg::RSHT, @2.S, @2.E);}|
         t rshti {$$ = 5; opc = OPERAND(Reg, UCPSReg::RSHT, @2.S, @2.E);};
rshtt: RSHT t ;
...
divrop: DIVR {$$ = 0;};
uaryexp: NOT t {$$ = 1; opc = OPERAND(Reg, UCPSReg::NOT, @1.S, @1.E);};
binaryexp: t binaryop t {$$ = 2;};
binaryop: AND {opc = OPERAND(Reg, UCPSReg::AND, @1.S, @1.E);}|
          OR {opc = OPERAND(Reg, UCPSReg::OR, @1.S, @1.E);}|
          XOR {opc = OPERAND(Reg, UCPSReg::XOR, @1.S, @1.E);};
lshtclause: lshtexp _flag bflag flag_ | lshtexp;
lshtexp: t LSHT t {$$ = 2; opc = OPERAND(Reg, UCPSReg::LSHT, @1.S, @1.E);}|
         t LSHT imm5 {$$ = 5; opc = OPERAND(Reg, UCPSReg::LSHT, @1.S, @1.E); imm = OPERAND(Imm, $3, @2.S, @2.E);};
uthclause: cprsexp _flag uthflag flag_ | cprsexp;
cprsexp: CPRS _flag dupara flag_ {$$ = 4; opc = OPERAND(Reg, UCPSReg::CPRS, @$.S, @$.E);};
...
reduceexp: RMAX t {opc = OPERAND(Reg, UCPSReg::RMAX, @1.S, @1.E);}|
           RMIN t {opc = OPERAND(Reg, UCPSReg::RMIN, @1.S, @1.E);};

divinst: divexp ASSIGNTO DIVR {
  flags.reset();
  ADDOPERAND(Opc, UCPS::IALUDivR, @$.S, @$.E);
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(opc));
};
divinst: divsexp ASSIGNTO DIVR {
  ADDOPERAND(Opc, UCPS::IALUDivS, @$.S, @$.E);
  Operands.push_back(nullptr);
  condpos = Operands.size();
  ADDOPERAND(Reg, UCPSReg::DIVS, @$.S, @$.E);
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tn));
...
divqop: DIVQ { opc = OPERAND(Reg, UCPSReg::DIVQ, @$.S, @$.E); };
mdivrop: MDIVR { opc = OPERAND(Reg, UCPSReg::MDIVR, @$.S, @$.E); };
mdivqop: MDIVQ { opc = OPERAND(Reg, UCPSReg::MDIVQ, @$.S, @$.E); };

ialuctrl: ialu DOT ctrl {
  if ($3) ADDOPERAND(Opc, UCPS::IALUStop, @$.S, @$.E);
  else ADDOPERAND(Opc, UCPS::IALUStart, @$.S, @$.E);
};
...
imacinst: imacclause ASSIGNTO imacdest {
  ...
  case 0:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IMRToM, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IMulToM, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IMASToM, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IMAccToM, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IMaCToM, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::IMAToM, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    break;
  case 1:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IMRToSHU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IMulToSHU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IMASToSHU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IMAccToSHU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IMaCToSHU, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::IMAToSHU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  case 2:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IMRToBIU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IMulToBIU, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IMASToBIU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IMAccToBIU, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IMaCToBIU, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::IMAToBIU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b));
    break;
  case 3:
    switch($1) {
    case 0: ADDOPERAND(Opc, UCPS::IMRToMACC, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::IMulToMACC, @$.S, @$.E); break;
    case 3: ADDOPERAND(Opc, UCPS::IMASToMACC, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::IMAccToMACC, @$.S, @$.E); break;
    case 5: ADDOPERAND(Opc, UCPS::IMaCToMACC, @$.S, @$.E); break;
    case 6: ADDOPERAND(Opc, UCPS::IMAToMACC, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  condpos = Operands.size();
  if ($1 != 0) {
    if ($1 <= 3) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(opc));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
    if ($1 != 4) {
      Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tn));
      if ($1 == 2 || $1 == 3 || $1 == 6) {
        if ($1 == 2) tp = OPERAND(Reg, UCPSReg::T0, @$.S, @$.E);
        Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tp));
      }
    }
  }
...
mulexp: t MUL t;
imulclause: mulexp _flag t_uibflag flag_ {opc = OPERAND(Reg, UCPSReg::IMULT, @1.S, @1.E);}
|           mulexp _flag b_uiflag flag_ {opc = OPERAND(Reg, UCPSReg::IMUL, @1.S, @1.E);};
//|           mulexp _flag uiflag flag_ {opc = OPERAND(Reg, UCPSReg::IMUL, @1.S, @1.E);};
...
muladsbexp: t ADDSUB mulexp _flag hflag flag_ {UCPS::UCPSAsmOperand *tmp = tp; tp = tm; tm = tn; tn = tmp; opc = OPERAND(Reg, UCPSReg::IMULS, @$.S, @$.E);};
...
exmacexp: MR ASSIGN t ADD mulexp {$$ = 3; UCPS::UCPSAsmOperand *tmp = tp; tp = tm; tm = tn; tn = tmp;};
...
imacctrl: imac DOT ctrl {
  if ($3) ADDOPERAND(Opc, UCPS::IMACStop, @$.S, @$.E);
  else ADDOPERAND(Opc, UCPS::IMACStart, @$.S, @$.E);
};
...
faluinst: faluclause ASSIGNTO faludest {
  ...
  case 0:
    switch($1) {
    case 1: ADDOPERAND(Opc, UCPS::FALUUryToM, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FALUBinToM, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::FALUDParaToM, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md)); 
    break;
  case 1:
    switch($1) {
    case 1: ADDOPERAND(Opc, UCPS::FALUUryToSHU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FALUBinToSHU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::FALUDParaToSHU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit)); 
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut)); 
  ...
  case 2:
    switch($1) {
    case 1: ADDOPERAND(Opc, UCPS::FALUUryToBIU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FALUBinToBIU, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::FALUDParaToBIU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b)); 
    break;
  case 3:
    switch($1) {
    case 1: ADDOPERAND(Opc, UCPS::FALUUryToMACC, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FALUBinToMACC, @$.S, @$.E); break;
    case 4: ADDOPERAND(Opc, UCPS::FALUDParaToMACC, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit)); 
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut)); 
...
tsdclause: faddclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FADD, @$.S, @$.E);}|
           fsubclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FSUB, @$.S, @$.E);};
faddclause: addexp _flag tsdflag flag_;
fsubclause: subexp _flag tsdflag flag_;
sdclause: fmaxclause {$$ = 4; opc = OPERAND(Reg, UCPSReg::FMAX, @$.S, @$.E);} |
          fminclause {$$ = 4; opc = OPERAND(Reg, UCPSReg::FMIN, @$.S, @$.E);};
sdclause: recipclause | rsqrtclause | intclause | fabsclause ;
sdclause: fequclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FEQU, @$.S, @$.E);}|
          fneqclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FNEQ, @$.S, @$.E);}|
          fltclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FLT, @$.S, @$.E);}|
          fnstclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FNST, @$.S, @$.E);}|
          fstclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FST, @$.S, @$.E);}|
          fnltclause {$$ = 2; opc = OPERAND(Reg, UCPSReg::FNLT, @$.S, @$.E);};
...
absexp: ABS t {$$ = 1; opc = OPERAND(Reg, UCPSReg::FABS, @1.S, @1.E);};
...
recipexp: RECIP t {$$ = 1; opc = OPERAND(Reg, UCPSReg::RECIP, @1.S, @1.E);};
...
rsqrtexp: RSQRT t {$$ = 1; opc = OPERAND(Reg, UCPSReg::RSQRT, @1.S, @1.E);};
...
intexp: intop t {$$ = 1; opc = OPERAND(Reg, UCPSReg::INT, @1.S, @1.E);}|
        uintop t {$$ = 1; opc = OPERAND(Reg, UCPSReg::UINT, @1.S, @1.E);};
intop: INT ;
uintop: UINT ;
...
tosexp: SINGLE t {$$ = 1; opc = OPERAND(Reg, UCPSReg::SINGLE, @1.S, @1.E);};
sclause: todexp _flag sflag flag_ |
         fasexp _flag sflag flag_;
fasexp: t ADDSUB t {$$ = 2; opc = OPERAND(Reg, UCPSReg::ADDSUB, @2.S, @2.E);};
todexp: DOUBLE t {$$ = 1; opc = OPERAND(Reg, UCPSReg::DOUBLE, @1.S, @1.E);};
...
faluctrl: falu DOT ctrl {
  if ($3) ADDOPERAND(Opc, UCPS::FALUStop, @$.S, @$.E);
  else ADDOPERAND(Opc, UCPS::FALUStart, @$.S, @$.E);
};
...
fmacinst: fmacclause ASSIGNTO fmacdest {
  ...
  case 0:
    switch($1) {
    case 3: ADDOPERAND(Opc, UCPS::FMaCToM, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FMulToM, @$.S, @$.E); break;
    //case 0: ADDOPERAND(Opc, UCPS::FMRToM, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(md));
    break;
  case 1:
    switch($1) {
    case 3: ADDOPERAND(Opc, UCPS::FMaCToSHU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FMulToSHU, @$.S, @$.E); break;
    //case 0: ADDOPERAND(Opc, UCPS::FMRToSHU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  case 2:
    switch($1) {
    case 3: ADDOPERAND(Opc, UCPS::FMaCToBIU, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FMulToBIU, @$.S, @$.E); break;
    //case 0: ADDOPERAND(Opc, UCPS::FMRToBIU, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(b));
    break;
  case 3:
    switch($1) {
    case 3: ADDOPERAND(Opc, UCPS::FMaCToMACC, @$.S, @$.E); break;
    case 2: ADDOPERAND(Opc, UCPS::FMulToMACC, @$.S, @$.E); break;
    //case 0: ADDOPERAND(Opc, UCPS::FMRToMACC, @$.S, @$.E); break;
    default: break;
    }
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(ut));
  ...
  condpos = Operands.size();
  if ($1 != 0) {
    if ($1 == 2) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(opc));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tm));
    Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(tn));
    if ($1 == 2) {
      tp = OPERAND(Reg, UCPSReg::T0, @$.S, @$.E);
...
fmulclause: mulexp _flag tsdflag flag_ {$$ = 2; opc = OPERAND(Reg, UCPSReg::FMUL, @1.S, @1.E);};
fmulclause: cmulexp _flag sflag flag_ {$$ = 2;};
cmulexp: t CMUL t {opc = OPERAND(Reg, UCPSReg::CMUL, @2.S, @2.E);};
...
fmacctrl: fmac DOT ctrl {
  if ($3) ADDOPERAND(Opc, UCPS::FMACStop, @$.S, @$.E);
  else ADDOPERAND(Opc, UCPS::FMACStart, @$.S, @$.E);
};

reinst: REPEAT ALPHA _flag repeatexp {Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(imm));};
reinst: REPEAT ALPHA _flag error {llvmerror(&@4, "Invalid condition expression."); YYABORT;}
repeatexp: immrep {ADDOPERAND(Opc, UCPS::REPEATIMM, @-2.S, @$.E);} |
           regrep flag_ {
  ADDOPERAND(Opc, UCPS::REPEATK, @-2.S, @$.E);
  Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(imm));
...
lpexp: LOOP label ALPHA {
  ADDOPERAND(Opc, UCPS::LPTO, @$.S, @$.E);
  if (expr) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(expr));
...
jmpinst: JMP label ALPHA condexp {
  ...
  if (imm) Operands.push_back(std::unique_ptr<UCPS::UCPSAsmOperand>(imm));
};
condexp: _flag trueflag flag_ {ADDOPERAND(Opc, UCPS::JUMP, @-2.S, @$.E);}|
         regrep {ADDOPERAND(Opc, UCPS::JUMPK, @-2.S, @$.E);};
mpustop: MPUSTOP {ADDOPERAND(Opc, UCPS::MPUStop, @$.S, @$.E);};
...
ialut: ialu DOT t {$$ = 3; unit = OPERAND(Reg, UCPSReg::IALU, @1.S, @1.E); if (!ut) ut = tp ? tp : (tn ? tn : tm);};
imact: imac DOT t {$$ = 3; unit = OPERAND(Reg, UCPSReg::IMAC, @1.S, @1.E); if (!ut) ut = tp ? tp : (tn ? tn : tm);};
falut: falu DOT t {$$ = 3; unit = OPERAND(Reg, UCPSReg::FALU, @1.S, @1.E); if (!ut) ut = tp ? tp : (tn ? tn : tm);};
fmact: fmac DOT t {$$ = 3; unit = OPERAND(Reg, UCPSReg::FMAC, @1.S, @1.E); if (!ut) ut = tp ? tp : (tn ? tn : tm);};
biu0: BIU0 {$$ = 2; b = OPERAND(Reg, UCPSReg::BIU0, @$.S, @$.E);};
biu1: BIU1 {$$ = 2; b = OPERAND(Reg, UCPSReg::BIU1, @$.S, @$.E);};
biu2: BIU2 {$$ = 2; b = OPERAND(Reg, UCPSReg::BIU2, @$.S, @$.E);};
shu0t: SHU0 DOT t {$$ = 1; unit = OPERAND(Reg, UCPSReg::SHU0, @1.S, @1.E); if (!ut) ut = tp ? tp : (tn ? tn : tm);};
shu1t: SHU1 DOT t {$$ = 1; unit = OPERAND(Reg, UCPSReg::SHU1, @1.S, @1.E); if (!ut) ut = tp ? tp : (tn ? tn : tm);};
mindexs: MINDEXS {$$ = 0; ms = md; md = OPERAND(Reg, UCPSReg::MSPP, @$.S, @$.E);};
mindexi: MINDEXI {$$ = 0; ms = md; md = OPERAND(Reg, UCPSReg::MIPP, @$.S, @$.E);};
mindexn: MINDEXN {$$ = 0; ms = md;
  md = OPERAND(Reg,
               MRI->getRegClass(UCPSReg::MRegRegClassID).getRegister($1),
               @$.S, @$.E);
};
t: TREG {
  unsigned treg = MRI->getRegClass(UCPSReg::TPortRegClassID).getRegister($1);
...
cflag: C ;
ncflag: NEG C ;
condflag: ALPHA _flag cflag flag_ {if (condpos) Operands[condpos-1].reset(OPERAND(Reg, UCPSReg::C, @$.S, @$.E));}
|         ALPHA _flag ncflag flag_ {if (condpos) Operands[condpos-1].reset(OPERAND(Reg, UCPSReg::NC, @$.S, @$.E));}
|         {if (condpos) Operands[condpos-1].reset(OPERAND(Reg, UCPSReg::NOC, @$.S, @$.E));};
