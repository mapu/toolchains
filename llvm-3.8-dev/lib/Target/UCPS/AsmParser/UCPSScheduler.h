...
#ifndef UCPSSCHEDULER_H
#define UCPSSCHEDULER_H
...
public:
  //yangl #define INSTRUCTION_LIST_LEN (UCPS::INSTRUCTION_LIST_END - UCPS::BIU0KG)
  ...
  UCPSScheduler(MCAsmParser &Parser) : CurPoint(0), Parser(&Parser) {
    allocResvRecord();
  };

  UCPSScheduler() : CurPoint(0) {
    Parser = NULL;
    allocResvRecord();
  };
