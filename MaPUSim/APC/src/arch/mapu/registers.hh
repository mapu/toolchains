#ifndef __ARCH_MAPU_REGISTERS_HH__
#define __ARCH_MAPU_REGISTERS_HH__

#include "arch/mapu/generated/max_inst_regs.hh"
...
namespace MapuISA
{
using MapuISAInst::MaxInstSrcRegs;
using MapuISAInst::MaxInstDestRegs;
using MapuISAInst::MaxMiscDestRegs;
...
const uint32_t MAPU32_QNAN = 0x7fbfffff;
const uint64_t MAPU64_QNAN = ULL(0x7ff7ffffffffffff);
