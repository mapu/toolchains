#ifndef __ARCH_UCP_LINUX_LINUX_TREADNIFO_HH__
#define __ARCH_UCP_LINUX_LINUX_TREADNIFO_HH__
...
class ThreadInfo
{
  ...
  public:
    ...
    curThreadInfo()
    {
        panic("curThreadInfo not implemented for UCP");
        Addr addr = pcbb;
        Addr sp;

        if (!addr)
            addr = tc->readMiscRegNoEffect(0/*UcpISA::IPR_PALtemp23*/);
...
#endif // __ARCH_UCP_LINUX_LINUX_THREADINFO_HH__
