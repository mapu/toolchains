#ifndef __UCP_FAULTS_HH__
#define __UCP_FAULTS_HH__
...
class UcpFaultBase : public FaultBase
{
  public:
    struct FaultVals
    {
...
template <typename T>
class UcpFault : public UcpFaultBase
{
  protected:
...
class SystemCallFault : public UcpFault<SystemCallFault> {};
class ReservedInstructionFault : public UcpFault<ReservedInstructionFault> {};
class ThreadFault : public UcpFault<ThreadFault> {};
class IntegerOverflowFault : public UcpFault<IntegerOverflowFault> {};
class TrapFault : public UcpFault<TrapFault> {};
class BreakpointFault : public UcpFault<BreakpointFault> {};
class DspStateDisabledFault : public UcpFault<DspStateDisabledFault> {};

class MachineCheckFault : public UcpFault<MachineCheckFault>
{
  public:
    bool isMachineCheckFault() { return true; }
};

class ResetFault : public UcpFault<ResetFault>
{
  public:
    void invoke(ThreadContext * tc,
            StaticInstPtr inst = StaticInst::nullStaticInstPtr);
...
class SoftResetFault : public UcpFault<SoftResetFault>
{
  public:
    void invoke(ThreadContext * tc,
            StaticInstPtr inst = StaticInst::nullStaticInstPtr);
...
class NonMaskableInterrupt : public UcpFault<NonMaskableInterrupt>
{
  public:
    void invoke(ThreadContext * tc,
            StaticInstPtr inst = StaticInst::nullStaticInstPtr);
...
class CoprocessorUnusableFault : public UcpFault<CoprocessorUnusableFault>
{
  protected:
    int coProcID;
  public:
    ...
    invoke(ThreadContext * tc,
            StaticInstPtr inst = StaticInst::nullStaticInstPtr)
    {
        UcpFault<CoprocessorUnusableFault>::invoke(tc, inst);
        if (FullSystem) {
...
class InterruptFault : public UcpFault<InterruptFault>
{
  public:
    FaultVect
...
template <typename T>
class AddressFault : public UcpFault<T>
{
  protected:
    Addr vaddr;
    bool store;
...
class TlbModifiedFault : public TlbFault<TlbModifiedFault>
{
  public:
    ...
    ExcCode code() const { return UcpFault<TlbModifiedFault>::code(); }
};

} // namespace UcpISA

#endif // __UCP_FAULTS_HH__
