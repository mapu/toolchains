...
// for BIU0    
  ...
  //KC1 = R6 ;;
    ...
    // for BIU1    
    //R1 =  SDA1DM0_START + BldEpochNum * EpochTwiSize  + UnBldEpoTwiOff * BlockSize  ;; // KB for BIU1  
    //R2 =  GrpEpochTwiSize    ;; // KS4
    //R3 =  PipeGrp            ;; // KC4
    //R4 =  PipeGrp            ;; // KI4   
    //R5 =  BlockSize          ;; // KS5
    //R6 =  UnBldEpoStageNum        ;; // KC5
    //R7 =  UnBldEpoStageNum        ;; // KI5  
    //R8 =  PipeGrpEpochTwiSize     ;; // KS6
    //R9 =  PipeGrpNum              ;; // KC6
    //R10=  PipeGrpNum              ;; // KI6    
    //R14=  BlockGran               ;; // KG1
    //R15=  UnBldEpoBCirNum         ;; // KL1
...
*/    
   // for BIU2    
    R1 =  SDA2DM0_START                    ;; // KB for BIU0  
    R2 =  DataSize * DataSizeMag           ;; // KS8
    R3 =  ABSLen                           ;; // KC8
    R4 =  ABSLen                           ;; // KI8    
    R14=  DataSizeGran + DataSizeGranMag   ;; // KG2
    R15=  CCirNum                          ;; // KL2
