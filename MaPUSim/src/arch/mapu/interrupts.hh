#ifndef __ARCH_MAPU_INTERRUPT_HH__
#define __ARCH_MAPU_INTERRUPT_HH__
...
#include "params/MapuInterrupts.hh"
...
{
  public:
    typedef MapuInterruptsParams Params;
...
#endif // __ARCH_MAPU_INTERRUPT_HH__
