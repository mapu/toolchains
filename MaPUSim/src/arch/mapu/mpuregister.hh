...
public:
  ...
  static int8_t *carry_b(MPURegister &lhs, MPURegister &rhs);
  static int16_t *carry_h(MPURegister &lhs, MPURegister &rhs);
  static int32_t *carry_w(MPURegister &lhs, MPURegister &rhs);
