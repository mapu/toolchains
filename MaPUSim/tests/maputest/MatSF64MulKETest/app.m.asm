...
.hmacro HM_BIU0
LPTO 3f AT (KI14); LPTO 2f AT (KI13-1); LPTO 1f AT (KI12);;
SHU0.T0 = BIU0.DM (A++)(K++);;
Repeat AT (14);;
LPTO 3f AT (KI12);;
1:
2:
SHU0.T0 = BIU0.DM (M)(A++)(K++);;
Repeat AT (15);;
3:
.endhmacro
...
.hmacro HM_BIU1
LPTO 3f AT (KI14); LPTO 2f AT (KI13-1);;
M[I++].w1 = BIU1.DM (A++)(K++); Repeat AT(15);;
M[I++].w1 = BIU1.DM (A++)(K++); LPTO 1f AT (KI12-1);;
Repeat AT (16);;
1:
2:
M[I++].w1 = BIU1.DM (A++)(K++); Repeat AT(N);;
M[I++].w1 = BIU1.DM ; Repeat AT(15-N);;
M[I++].w1 = BIU1.DM ; LPTO 3f AT (KI12-1);;
Repeat AT (16);;
3:
.endhmacro

.hmacro HM_BIU2_ST
LPTO 1f AT (KI14-1); LPTO 1f AT (KI13); LPTO 1f AT (KI12);;
DM = BIU2 (A++)(K++);;
Repeat AT (14);;
LPTO 2f AT (KI13); LPTO 2f AT (KI12);;
1:
DM = BIU2 (M)(A++)(K++);;
Repeat AT (15);;
2:
...
.hmacro HM_BIU2_LD
LPTO 2f AT (KI14-1);LPTO 1f AT (KI12);;
Repeat AT (15);;
LPTO 2f AT (KI13-1); LPTO 2f AT (KI12);;
1:
FALU.T1 (I2) = BIU2.DM ;;
Repeat AT (14);;
LPTO 3f AT (KI12);;
2:
Repeat AT (15);;
LPTO 4f AT (KI13-1); LPTO 4f AT (KI12);;
3:
FALU.T1 (I2) = BIU2.DM (M);;
Repeat AT (15);;
4:
.endhmacro
