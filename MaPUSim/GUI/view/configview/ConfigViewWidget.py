...
class ConfigViewWidget(QMainWindow):
	...
	self.traceFileLabel.setFixedSize(110,25)
	self.traceFileEdit=QLineEdit(self.tr(""))
	self.traceFileEdit.setFixedSize(500,25)	
	blank10=QLabel()
	blank10.setFixedSize(520,25)
	...
	self.startButton.setFixedSize(100,25)
	self.stopButton=QPushButton("Stop")
	self.stopButton.setFixedSize(100,25)
	...
	self.fullBrowserButton.setFixedSize(100,25)
	self.fullEdit=QLineEdit()
	self.fullEdit.setFixedSize(500,25)
	blank8=QLabel()
	blank8.setFixedSize(405,25)
	fullTraceLabel=QLabel("Trace file name:")
	fullTraceLabel.setFixedSize(110,25)
	self.fullTracefile=QLineEdit()
	self.fullTracefile.setFixedSize(500,25)
	blank9=QLabel()
	blank9.setFixedSize(520,25)	
	#full Layout
	...
	fixedWidget=QWidget()
	fixedWidget.setFixedSize(1180,590)
	fixedWidget.setLayout(mainLay)

	fixedLay=QGridLayout()
	fixedLay.addWidget(fixedWidget,0,0)	
