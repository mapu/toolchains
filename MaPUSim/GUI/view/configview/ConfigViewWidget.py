...
class ConfigViewWidget(QWidget):
	...
	self.APE0SPUEdit=QLineEdit(self.tr("Trace file name"))
	self.APE0SPUEdit.setFixedSize(400,25)
	...
	self.APE0MPUEdit=QLineEdit(self.tr("Trace file name"))
	self.APE0MPUEdit.setFixedSize(400,25)
	...
	self.APE1SPUEdit.setFixedSize(400,25)
	...
	self.APE1MPUEdit.setFixedSize(400,25)
	...
	self.APE2SPUEdit.setFixedSize(400,25)
	...
	self.APE2MPUEdit.setFixedSize(400,25)
	...
	self.APE3SPUEdit.setFixedSize(400,25)
	...
	self.APE3MPUEdit.setFixedSize(400,25)
