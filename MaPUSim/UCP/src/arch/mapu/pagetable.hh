#ifndef __ARCH_MAPU_PAGETABLE_H__
#define __ARCH_MAPU_PAGETABLE_H__
...
// WARN: This particular TLB entry is not necessarily conformed to Mapu ISA
struct TlbEntry
{
    Addr _pageStart;
    TlbEntry() {}
...
#endif // __ARCH_MAPU_PAGETABLE_H__
