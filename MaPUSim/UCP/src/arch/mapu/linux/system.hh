#ifndef __ARCH_MAPU_LINUX_SYSTEM_HH__
#define __ARCH_MAPU_LINUX_SYSTEM_HH__
...
#include "params/LinuxMapuSystem.hh"
 ...
 */
class LinuxMapuSystem : public MapuSystem
{
  private:
     ...
     * elements.  Details found in include/asm-mapu/system.h
     */
  ...
  public:
    typedef LinuxMapuSystemParams Params;
    LinuxMapuSystem(Params *p);
    ~LinuxMapuSystem();

    void setDelayLoop(ThreadContext *tc);
};

#endif // __ARCH_MAPU_LINUX_SYSTEM_HH__
