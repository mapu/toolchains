...
#include "arch/mapu/linux/process.hh"
...
SyscallDesc MapuSPUProcess::syscallDescs[] = {
    /*  0 */ SyscallDesc("syscall", unimplementedFunc),
    /*  1 */ SyscallDesc("exit", exitFunc),
    /*  2 */ SyscallDesc("fork", unimplementedFunc),
    /*  3 */ SyscallDesc("read", readFunc),
    /*  4 */ SyscallDesc("write", writeFunc),
    /*  5 */ SyscallDesc("open", openFunc<MapuLinux>),
    ...
    /* 15 */ SyscallDesc("chmod", chmodFunc<MapuLinux>),
    ...
    /* 54 */ SyscallDesc("ioctl", ioctlFunc<MapuLinux>),
    ...
    /* 77 */ SyscallDesc("getrusage", getrusageFunc<MapuLinux>),
    ...
    /* 106 */ SyscallDesc("stat",  statFunc<MapuLinux>),
    /* 107 */ SyscallDesc("lstat", unimplementedFunc),
    /* 108 */ SyscallDesc("fstat", fstatFunc<MapuLinux>),
    ...
    /* 116 */ SyscallDesc("sysinfo", sysinfoFunc<MapuLinux>),
    ...
    /* 167 */ SyscallDesc("mremap", mremapFunc<MapuLinux>),
    ...
    /* 214 */ SyscallDesc("lstat64", lstat64Func<MapuLinux>),
    /* 215 */ SyscallDesc("fstat64", fstat64Func<MapuLinux>),
...
SyscallDesc*
MapuSPUProcess::getDesc(int callnum)
{
...
MapuMPUProcess::MapuMPUProcess(LiveProcessParams * params,
                                     ObjectFile *objFile)
    : LiveProcess(params, objFile)
{  }

MapuISA::IntReg
MapuMPUProcess::getSyscallArg(ThreadContext *tc, int &i)
{
...
void
MapuMPUProcess::setSyscallArg(ThreadContext *tc,
...
void
MapuMPUProcess::setSyscallReturn(ThreadContext *tc,
...
SyscallDesc*
MapuMPUProcess::getDesc(int callnum)
{
	if (callnum == 246) return &MapuSPUProcess::syscallDescs[246];
	assert(0 && "MPU doesn't support syscall\n");
    return NULL;
}
