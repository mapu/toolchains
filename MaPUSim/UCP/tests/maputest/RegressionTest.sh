...
###########################################################
#############################################################
echo "Check MaPU tools ..."
: ${MAPU_HOME:?"Cannot find LLVM tools. Please set MAPU_HOME to the root path of MaPU SDK"}
...
echo "30.Running dul2uint test ..."
if [ ! -d ./m5out/DFALUTest ];\
then mkdir m5out/DFALUTest
fi
make -C DFALUTest/dul2uint
../../build/MAPU/gem5.debug --debug-flags=Exec,-ExecSymbol --trace-file=DFALUTest/dul2uint.out --stats-file=DFALUTest/stat.txt --dump-config=DFALUTest/config.ini --json-config=DFALUTest/config.json -r --stdout-file=DFALUTest/stdout -e --stderr-file=DFALUTest/stderr  ../../configs/example/se.py -c DFALUTest/dul2uint/app.s.out,DFALUTest/dul2uint/app.m.out
if cmp -s m5out/DFALUTest/dul2uint.out ./DFALUTest/dul2uint/dul2uint.out
then echo -e "\e[32m\e[1m dul2uint test passed~\e[0m" 
#rm -rf m5out/DFALUTest
else echo -e "\e[31m\e[1mError in dul2uint test!\e[0m"
fi

echo "31.Running dul2int test ..."
if [ ! -d ./m5out/DFALUTest ];\
then mkdir m5out/DFALUTest
fi
make -C DFALUTest/dul2int
../../build/MAPU/gem5.debug --debug-flags=Exec,-ExecSymbol --trace-file=DFALUTest/dul2int.out --stats-file=DFALUTest/stat.txt --dump-config=DFALUTest/config.ini --json-config=DFALUTest/config.json -r --stdout-file=DFALUTest/stdout -e --stderr-file=DFALUTest/stderr  ../../configs/example/se.py -c DFALUTest/dul2int/app.s.out,DFALUTest/dul2int/app.m.out
if cmp -s m5out/DFALUTest/dul2int.out ./DFALUTest/dul2int/dul2int.out
then echo -e "\e[32m\e[1m dul2int test passed~\e[0m" 
#rm -rf m5out/DFALUTest
else echo -e "\e[31m\e[1mError in dul2int test!\e[0m"
fi

echo "32.Running dul2sig test ..."
if [ ! -d ./m5out/DFALUTest ];\
then mkdir m5out/DFALUTest
fi
make -C DFALUTest/dul2sig
../../build/MAPU/gem5.debug --debug-flags=Exec,-ExecSymbol --trace-file=DFALUTest/dul2sig.out --stats-file=DFALUTest/stat.txt --dump-config=DFALUTest/config.ini --json-config=DFALUTest/config.json -r --stdout-file=DFALUTest/stdout -e --stderr-file=DFALUTest/stderr  ../../configs/example/se.py -c DFALUTest/dul2sig/app.s.out,DFALUTest/dul2sig/app.m.out
if cmp -s m5out/DFALUTest/dul2sig.out ./DFALUTest/dul2sig/dul2sig.out
then echo -e "\e[32m\e[1m dul2sig test passed~\e[0m" 
#rm -rf m5out/DFALUTest
else echo -e "\e[31m\e[1mError in dul2sig test!\e[0m"
fi

echo "33.Running sig2dul test ..."
if [ ! -d ./m5out/DFALUTest ];\
then mkdir m5out/DFALUTest
fi
make -C DFALUTest/sig2dul
../../build/MAPU/gem5.debug --debug-flags=Exec,-ExecSymbol --trace-file=DFALUTest/sig2dul.out --stats-file=DFALUTest/stat.txt --dump-config=DFALUTest/config.ini --json-config=DFALUTest/config.json -r --stdout-file=DFALUTest/stdout -e --stderr-file=DFALUTest/stderr  ../../configs/example/se.py -c DFALUTest/sig2dul/app.s.out,DFALUTest/sig2dul/app.m.out
if cmp -s m5out/DFALUTest/sig2dul.out ./DFALUTest/sig2dul/sig2dul.out
then echo -e "\e[32m\e[1m sig2dul test passed~\e[0m" 
#rm -rf m5out/DFALUTest
else echo -e "\e[31m\e[1mError in sig2dul test!\e[0m"
fi

echo "34.Running int2dul test ..."
if [ ! -d ./m5out/DFALUTest ];\
then mkdir m5out/DFALUTest
fi
make -C DFALUTest/int2dul
../../build/MAPU/gem5.debug --debug-flags=Exec,-ExecSymbol --trace-file=DFALUTest/int2dul.out --stats-file=DFALUTest/stat.txt --dump-config=DFALUTest/config.ini --json-config=DFALUTest/config.json -r --stdout-file=DFALUTest/stdout -e --stderr-file=DFALUTest/stderr  ../../configs/example/se.py -c DFALUTest/int2dul/app.s.out,DFALUTest/int2dul/app.m.out
if cmp -s m5out/DFALUTest/int2dul.out ./DFALUTest/int2dul/int2dul.out
then echo -e "\e[32m\e[1m int2dul test passed~\e[0m" 
#rm -rf m5out/DFALUTest
else echo -e "\e[31m\e[1mError in int2dul test!\e[0m"
fi
...
echo "4.Running BicubicTest..."
if [ ! -d ./m5out/BicubicTest ];\
then mkdir m5out/BicubicTest
fi
../../build/MAPU/gem5.debug --stats-file=BicubicTest/stat.txt --dump-config=BicubicTest/config.ini --json-config=BicubicTest/config.json -r --stdout-file=BicubicTest/stdout -e --stderr-file=BicubicTest/stderr ../../configs/example/ms.py -c /dev/ape&
cd BicubicTest
make
./bicubic > ../m5out/BicubicTest/driver.out
cd ..
if cmp -s m5out/BicubicTest/out2.bmp ./BicubicTest/out2.bmp
  then echo -e "\e[32m\e[1m Bicubic test passed~\e[0m"
  rm -rf m5out/BicubicTest
else
  echo -e "\e[31m\e[1mError in Bicubic test!\e[0m"
fi

# echo "5.Running FFTFloat64Ep0Test..."
...
# echo "7.Running FFTFloat128MTest..."
...
# echo "8.Running FFTFloat4096MTest..."
