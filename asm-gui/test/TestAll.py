...
class mytest(unittest.TestCase):
    ...
    def testSoftware(self):
        ...
        for i in xrange(4):
            ...
            QTest.keyClicks(self.inittablewidget,'tm + tn(u,b)->shu0.t0@(!c)')
        ...
        for i in xrange(4):
            ...
            self.inittablewidget.setCurrentCell(row + 1,column)
            QTest.keyClicks(self.inittablewidget,'t0|t1->shu.t0')
            self.inittablewidget.setCurrentCell(row + 2,column)
            QTest.keyClicks(self.inittablewidget,'max(t0,t3)(u,b)->falu.t2(i1)')
            self.inittablewidget.setCurrentCell(row + 3,column)
