...
//            SLOT( fireZModemDetected() ) );
    ...
    //connect( _shellProcess,SIGNAL(readyReadStandardError()),this,SLOT(readError()));
...
/*
void Session::setErrorFile(QString file)
{
   errorFile=file;
}

void Session::readError()
{
    QString text=_shellProcess->readAllStandardError().data();
    QFile f(errorFile);

    qDebug()<<"file"<<errorFile<<endl;
...
QProcess *Session::getProcess() const
{
