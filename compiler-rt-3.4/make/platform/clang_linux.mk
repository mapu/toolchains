...
########### MaPU SPU ############
# Build runtime libraries for MSPU.
SupportedArches += mspu

ifeq ($(call contains,$(SupportedArches),mspu),true)
Configs += full-mspu
Arch.full-mspu := mspu
endif
#################################
...
######### MaPU SPU ######
CFLAGS.full-mspu := -target mspu -Wall -Werror -nonewlibinc -O0 -g
########################
...
############ MaPU SPU ################
FUNCTIONS.full-mspu := $(CommonFunctions) $(ArchFunctions.mspu)
######################################
