...
MSPUELFObjectWriter::MSPUELFObjectWriter(uint8_t OSABI)
		: MCELFObjectTargetWriter(/*Is64Bit*/false, OSABI, ELF::EM_MSPU,/* HasRelocationAddend */true)
...
unsigned
MSPUELFObjectWriter::GetRelocType(const MCValue &Target,
									const MCFixup &Fixup,
									bool IsPCRel,
									bool IsRelocWithSymbol,
									int64_t Addend /* fixme: utilize it */) const
{
