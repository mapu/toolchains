...
#define JIM_MOD_EXTENSIONS ""
#define JIM_REFERENCES 1
#define JIM_STATIC_C_EXTS "aio array clock eventloop exec file load nvp package posix readdir regexp signal syslog"
#define JIM_STATIC_TCL_EXTS "glob stdlib tclcompat"
#define JIM_TCL_EXTENSIONS ""
/* #undef JIM_UTF8 */
