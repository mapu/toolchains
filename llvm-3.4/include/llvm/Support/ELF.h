...
enum {
  ...
  R_MSPU_PC17, // PC-relative address, bits 21-5
  R_MSPU_PC28, // PC-relative address, bits 27-0

  R_MSPU_11_B5, // 11 bits relo, bits 15-5
  R_MSPU_11_B10, // 11 bits relo, bits 20-10

  R_MSPU_17, // PC-irrelative address, bits 21-5
  R_MSPU_28,  // 28-bit extension, at bit 27-0
...
enum {
  R_MMPU_None       = 0,
  R_MMPU_11         = 1, // PC-irrelative address

  // for data sections
  R_MMPU_PC_8,     // 1 byte,  8 bits
  R_MMPU_PC_16,    // 2 bytes, 16 bits
  R_MMPU_PC_32,    // 32 bits
  R_MMPU_PC_64,    // 64 bits

  R_MMPU_8,     // 1 byte,  8 bits
  R_MMPU_16,    // 2 bytes, 16 bits
  R_MMPU_32,    // 32 bits
  R_MMPU_64    // 64 bits
};
