...
public:
  MCInst() : Opcode(0), Start(true), End(true), Prev(0), Next(0) {}
  ...
  void setPrev(MCInst * inst) {Prev = inst;}
  void setNext(MCInst * inst) {Next = inst;}

  MCInst * getPrev() const {return Prev;}
  MCInst * getNext() const {return Next;}

  MCInst * getPrev() {return Prev;}
  MCInst * getNext() {return Next;}
  //////////////////  MaPU hacking  //////////////////
