...
static unsigned getArchPointerBitWidth(llvm::Triple::ArchType Arch) {
  ...
  case llvm::Triple::mspu: // It does have 32-bit pointer.
  case llvm::Triple::mmpu:
  case llvm::Triple::mmpulite:
    return 32;
...
Triple Triple::get64BitArchVariant() const {
  ...
  case Triple::thumb:
  case Triple::xcore:
  case Triple::mspu: // no 64-bit variant
  case Triple::mmpu:
  case Triple::mmpulite:
    T.setArch(UnknownArch);
    break;
