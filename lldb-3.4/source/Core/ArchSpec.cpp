...
static const CoreDefinition g_core_definitions[ArchSpec::kNumCores] =
{
    ...
    // the order must be kept the same with "enum Core" definition.
    // 8-byte encoding is necessary for mspu because of imm-ext instructions.
    { eByteOrderLittle, 4,  4,16,llvm::Triple::mspu   , ArchSpec::eCore_mspu            , "mspu"     },
    { eByteOrderLittle, 4, 41,41,llvm::Triple::mmpu   , ArchSpec::eCore_mmpu            , "mmpu"     },
...
static const ArchDefinitionEntry g_elf_arch_entries[] =
{
    ...
    { ArchSpec::eCore_mspu            , llvm::ELF::EM_MSPU   , LLDB_INVALID_CPUTYPE, 0xFFFFFFFFu, 0xFFFFFFFFu }, // MaPU SPU
    { ArchSpec::eCore_mmpu            , llvm::ELF::EM_MMPU   , LLDB_INVALID_CPUTYPE, 0xFFFFFFFFu, 0xFFFFFFFFu }, // MaPU MPU
