...
mr012slot: R0 DOT r0inst {
  ...
  case 0:
    ...
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(md)));
    Operands.push_back(nullptr);
    condpos = Operands.size();
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ms));
    ADDOPERAND(Reg,
  ...
  case 1:
    ...
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ut));
    Operands.push_back(nullptr);
    condpos = Operands.size();
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(md));
    ADDOPERAND(Reg,
               MRI->getRegClass(MMPULiteReg::WFlagRegClassID).getRegister(0),
               @$.S, @$.E);
    break;
  case 3:
    ...
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ut));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ipath));
    Operands.push_back(nullptr);
    condpos = Operands.size();
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(md));
    ADDOPERAND(Reg,
...
| R1 DOT r1inst {
  ...
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(unit));
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ut));
  if ($3 == 3) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ipath));
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(md));
  ADDOPERAND(Reg,
...
mr3slot: mr3slot_ {
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(b));
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(md));
  if (!$1)
...
imacslot: imacinst | imacctrl | mrinst {
  ...
  Operands.push_back(nullptr);
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tm));
  if ($1 >= 2) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tn));
  if ($1 == 3) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tp));
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(f));
};
...
fmacslot: fmacinst | fmacctrl | fmrinst {
  ...
  condpos = Operands.size();
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tm));
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tn));
  if ($1 == 3) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tp));
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(f));
};
...
shu0inst: shuexp ASSIGNTO shu0dest {
  ...
  Operands.push_back(nullptr);
  condpos = Operands.size();
  if ($1 == 6) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(opc));
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tm));
  switch ($1) {
  case 2:
  case 3:
  case 6:
    ...
    if ($1 == 6) {
      ...
      Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tp));
      Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(f));
      break;
    }
  case 4:
  case 5:
    ...
    else Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(imm));
    break;
  default : break;
  }
...
ldinst: ldop lddest {
  ...
  if ($2 == 0) {
    ...
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(unit));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ut));
    if ($2 == 3) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(ipath));
  }
  Operands.push_back(nullptr);
  condpos = Operands.size();
};
...
ialuinst: ialuclause ASSIGNTO ialudest {
  ...
  condpos = Operands.size();
  if ($1 > 0) {
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(opc));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tm));
    if ($1 == 5) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(imm));
    else if ($1 != 0) {
      if ($1 == 1) tn = OPERAND(Reg, MMPULiteReg::T0, @$.S, @$.E);
      Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tn));
      if ($1 != 5 && $1 != 3) tp = OPERAND(Reg, MMPULiteReg::T0, @$.S, @$.E);
      if ($1 != 5) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tp));
    }
  }
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(f));
}
...
imacinst: imacclause ASSIGNTO imacdest {
  ...
  condpos = Operands.size();
  if ($1 != 0) {
    if ($1 <= 3) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(opc));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tm));
    if ($1 != 4) {
      Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tn));
      if ($1 == 2 || $1 == 3 || $1 == 6) {
...
fmacinst: fmacclause ASSIGNTO fmacdest {
  ...
  condpos = Operands.size();
  if ($1 != 0) {
    if ($1 == 2) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(opc));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tm));
    Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(tn));
    if ($1 == 2) {
      tp = OPERAND(Reg, MMPULiteReg::T0, @$.S, @$.E);
...
reinst: REPEAT ALPHA _flag repeatexp {Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(imm));};
...
repeatexp: immrep {ADDOPERAND(Opc, MMPULite::REPEATIMM, @-2.S, @$.E);} |
  ...
  Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(imm));
...
lpexp: LOOP label ALPHA {
  ...
  if (expr) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(expr));
...
jmpinst: JMP label ALPHA condexp {
  ...
  if (imm) Operands.push_back(std::unique_ptr<MMPULite::MMPULiteAsmOperand>(imm));
};
...
cflag: C ;
ncflag: NEG C ;
condflag: ALPHA _flag cflag flag_ {if (condpos) Operands[condpos-1].reset(OPERAND(Reg, MMPULiteReg::C, @$.S, @$.E));}
|         ALPHA _flag ncflag flag_ {if (condpos) Operands[condpos-1].reset(OPERAND(Reg, MMPULiteReg::NC, @$.S, @$.E));}
|         {if (condpos) Operands[condpos-1].reset(OPERAND(Reg, MMPULiteReg::NOC, @$.S, @$.E));};
