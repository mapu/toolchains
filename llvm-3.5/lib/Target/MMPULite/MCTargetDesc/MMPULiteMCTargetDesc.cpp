...
createMMPULiteMCSubtargetInfo(StringRef TT, StringRef CPU, StringRef FS) {
...
createMMPULiteMCCodeGenInfo(StringRef TT,
                            Reloc::Model RM,
                            CodeModel::Model CM,
                            CodeGenOpt::Level OL) {
...
static MCStreamer *
createMMPULiteMCStreamer(const Target &T,
                         StringRef TT,
                         MCContext &Ctx,
                         MCAsmBackend &MAB,
                         raw_ostream &_OS,
...
extern "C" void LLVMInitializeMMPULiteTargetMC() {
  ...
  TargetRegistry::RegisterMCObjectStreamer(TheMMPULiteTarget,
  ...
  TargetRegistry::RegisterMCRelocationInfo(TheMMPULiteTarget,
                                           createMMPULiteMCRelocationInfo);
}
