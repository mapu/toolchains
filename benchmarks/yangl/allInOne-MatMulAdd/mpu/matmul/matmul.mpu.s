...
//Modification
.hmacro HM_BIU2_LD
LPTO (2f ) @ (KI14-1)||LPTO (2f ) @ (KI13)|| LPTO (2f ) @ (KI12); 
 BIU2.DM ->FALU.T1 (I2) ; 
Repeat @ (8); 
BIU2(KG) -> M[64];
NOP;
...
LPTO (3f ) @ (KI14)|| LPTO (2f ) @ (KI13)|| LPTO (1f ) @ (KI12); 
 SHU0.T0 IND TBW (TB=+4)->FMAC.T0 (I0) ; 
...
.hmacro HM_FALU_MID
LPTO (1f ) @ (KI14)||LPTO (2f ) @ (KI13)|| LPTO (3f ) @ (KI12); 
 T0 + T1 (S)->FALU.T2 ; 
 T2 + T3 (S)->FALU.T3 ; 
 T0 + T1 (S)->FALU.T2 ; 
NOP; 
