...
*/
    ...
    //my_send_sub_matrix(BIU[0][0]+2608, (uint32_t)(Src+2101770), 1927, 167, 67, DT_HALF, 0);
    my_send_sub_matrix(BIU[0][0], (uint32_t)(Src+2101770), 1927, 167, 67, DT_HALF, 0);
...
*/
    ...
    fetch_matrix((uint32_t)Res0, BIU[0][0], 167, 67, DT_HALF, 0);
...
*/
    ...
    fetch_matrix((uint32_t)(ResultShort+0), BIU[1][0], 320, 120, DT_HALF, 0);
