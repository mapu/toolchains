...
int main() 
{
  ...
  __mspu_setKS(KS8, DataSize);
  __mspu_setKI(KI8, outW);

  __mspu_setKB(KB9, SDA2DM0_START);
  __mspu_setKS(KS9, outW *  DataSize);
  __mspu_setKI(KI9, ARowPadBSNum);

  __mspu_setKG(KG2, DataSizeGran);
  __mspu_setKL(KL2, W_CirNum);
  ...
  __mspu_setSVR(SVR0, 0, 0xff, MODE_H);
  ...
  __mspu_setKI(KI8, BS);
  __mspu_setKE(KE8, ARowPadNum % BS);//IMPORTANT !!!

  __mspu_setKB(KB9, SDA2DM0_START);
  __mspu_setKS(KS9, outW * DataSize);
  __mspu_setKI(KI9, ARowPadNum / BS);//IMPORTANT !!!
