//===-- UCPSTargetObjectFile.cpp - UCPS object files ------------------===//
//
...
static cl::opt<unsigned> SmallDataThreshold("ucps-small-data-threshold",
  cl::init(8), cl::Hidden,
...
static cl::opt<bool> StaticsInSData("ucps-statics-in-small-data",
...
bool UCPSTargetObjectFile::isSmallDataEnabled() const {
  return SmallDataThreshold > 0;
}


unsigned UCPSTargetObjectFile::getSmallDataSize() const {
...
unsigned UCPSTargetObjectFile::getSmallestAddressableSize(const Type *Ty,
...
MCSection *UCPSTargetObjectFile::
