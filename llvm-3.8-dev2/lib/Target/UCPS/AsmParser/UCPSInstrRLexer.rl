...
main := |*
  ...
  "dr"i('0'|([1-9][0-9]*)) => {
		assert(atoi(ts+2)<16);
		yylval->op = UCPS::UCPSAsmOperand::
		createReg((UCPS::UCPSAsmParser::getRegInfo())
		  ->getRegClass(UCPSReg::DRegRegClassID).getRegister(atoi(ts+2)));
  ...
  "kb"i('0'|([1-9][0-9]*)) => {
		...
		yylval->op = UCPS::UCPSAsmOperand::createReg(
		  (UCPS::UCPSAsmParser::getRegInfo())
		    ->getRegClass(UCPSReg::KBRegRegClassID).getRegister(atoi(ts+2)));
  ...
  "ke"i('0'|([1-9][0-9]*)) => {
		...
		yylval->op = UCPS::UCPSAsmOperand::createReg(
		  (UCPS::UCPSAsmParser::getRegInfo())
		  ->getRegClass(UCPSReg::KERegRegClassID).getRegister(atoi(ts+2)));
  ...
  "ks"i('0'|([1-9][0-9]*)) => {
		...
		yylval->op = UCPS::UCPSAsmOperand::createReg(
		  (UCPS::UCPSAsmParser::getRegInfo())
		    ->getRegClass(UCPSReg::KSRegRegClassID).getRegister(atoi(ts+2)));
  ...
  "ki"i('0'|([1-9][0-9]*)) => {
		...
		yylval->op = UCPS::UCPSAsmOperand::createReg(
		  (UCPS::UCPSAsmParser::getRegInfo())
		    ->getRegClass(UCPSReg::KIRegRegClassID).getRegister(atoi(ts+2)));
  ...
  "km"i('0'|'1'|'2') => {
		yylval->op = UCPS::UCPSAsmOperand::createReg(
		  (UCPS::UCPSAsmParser::getRegInfo())
		    ->getRegClass(UCPSReg::KMRegRegClassID).getRegister(atoi(ts+2)));
  ...
  "kg"i('0'|'1'|'2') => {
		yylval->op = UCPS::UCPSAsmOperand::createReg(
		  (UCPS::UCPSAsmParser::getRegInfo())
		    ->getRegClass(UCPSReg::KGRegRegClassID).getRegister(atoi(ts+2)));
  ...
  "kl"i('0'|'1'|'2') => {
		yylval->op = UCPS::UCPSAsmOperand::createReg(
		  (UCPS::UCPSAsmParser::getRegInfo())
		    ->getRegClass(UCPSReg::KLRegRegClassID).getRegister(atoi(ts+2)));
  ...
  "shu"i('0'|'1') => {
		yylval->op = UCPS::UCPSAsmOperand::createReg((UCPS::UCPSAsmParser::getRegInfo())->getRegClass(UCPSReg::SHURegRegClassID).getRegister(atoi(ts+3)));
		CurLoc = SMLoc::getFromPointer(te); return _SHUReg;
	};

  "t"i('0'|'1'|'2'|'3') => {
		yylval->op = UCPS::UCPSAsmOperand::createReg((UCPS::UCPSAsmParser::getRegInfo())->getRegClass(UCPSReg::TRegRegClassID).getRegister(atoi(ts+1)));
