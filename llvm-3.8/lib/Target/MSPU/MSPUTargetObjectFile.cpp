//===-- MSPUTargetObjectFile.cpp - MSPU object files ------------------===//
//
...
static cl::opt<unsigned> SmallDataThreshold("mspu-small-data-threshold",
  cl::init(8), cl::Hidden,
...
static cl::opt<bool> StaticsInSData("mspu-statics-in-small-data",
...
bool MSPUTargetObjectFile::isSmallDataEnabled() const {
  return SmallDataThreshold > 0;
}


unsigned MSPUTargetObjectFile::getSmallDataSize() const {
...
unsigned MSPUTargetObjectFile::getSmallestAddressableSize(const Type *Ty,
...
MCSection *MSPUTargetObjectFile::
