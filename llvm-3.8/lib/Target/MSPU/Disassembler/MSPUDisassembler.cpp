...
#define DEBUG_TYPE "mspu-disassembler"
...
static MCDisassembler *createMSPUDisassembler(const Target &T, const MCSubtargetInfo &STI, MCContext &Ctx) {
  return new MSPUDisassembler(STI, Ctx, T.createMCRegInfo(""), true);
}
